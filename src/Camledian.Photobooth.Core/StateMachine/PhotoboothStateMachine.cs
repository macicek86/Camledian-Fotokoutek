...
public class PhotoboothStateMachine
{
    private static readonly Dictionary<PhotoboothState, PhotoboothState[]> Transitions = new()
    {
        ...
        [PhotoboothState.Capturing] = [PhotoboothState.SelectingPhoto, PhotoboothState.Processing, PhotoboothState.Error],
        [PhotoboothState.SelectingPhoto] = [PhotoboothState.Processing, PhotoboothState.Preview, PhotoboothState.Idle],
